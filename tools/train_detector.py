...
sys.path.append(osp.join(osp.dirname(osp.dirname(__file__)), 'src', 'detection', 'vision', 'references', 'detection'))
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--train-dataset", default="motsynth", type=str, help="dataset name")
